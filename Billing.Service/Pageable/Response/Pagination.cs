...
namespace Billing.Service.Pageable
{
	...
	public class PageRange
	{
		...
		/// <summary>
		/// Checks if a range is valid according to the instance or the values in the instance
		/// </summary>
		/// <param name="range">The isntance that needs to be verified</param>
		/// <returns>True - valid range / False - invalid range</returns>
		public static bool IsValid(PageRange range)
		{
