...
namespace Billing.Service.Services.Implementations
{
    ...
    {
        public TipoPessoaService(DataContext mContext, IMapper mapper) : base(mapper, mContext) { }

        public async Task<TipoPessoaDto> Find(Expression<Func<TipoPessoa, bool>> predicate, Func<IQueryable<TipoPessoa>, IQueryable<TipoPessoa>> queryable = null)
        {
            ...
            return mapper.Map<TipoPessoaDto>(dbModel);
        }

        public async Task<List<TipoPessoaDto>> FindAll(Func<IQueryable<TipoPessoa>, IQueryable<TipoPessoa>> queryable = null)
        {
            // If the queryable argument is null define the default one
            if (queryable == null)
                queryable = func => func;
            ...
            return mapper.Map<List<TipoPessoaDto>>(dbModels);
        }

        public async Task<Pagination<TipoPessoaDto>> FindAll(PageRange range, Func<IQueryable<TipoPessoa>, IQueryable<TipoPessoa>> queryable = null)
        {
            if (range == null)
                return new Pagination<TipoPessoaDto>
                {
            ...
            return new Pagination<TipoPessoaDto>
            {
                ...
                Data = mapper.Map<List<TipoPessoaDto>>(pagination.Data)
            };
        }

        public async Task<TipoPessoaDto> FindById(string uid, Func<IQueryable<TipoPessoa>, IQueryable<TipoPessoa>> queryable = null)
        {
            // If the queryable argument is null define the default one
            if (queryable == null)
                queryable = func => func;
        ...
        public async Task Save(TipoPessoaDto model, bool isCommit = true)
        {
            var dbModel = mapper.Map<TipoPessoa>(model);
        ...
        public async Task Update(string uid, TipoPessoaDto model, bool isCommit = true)
        {
            var _uid = uid.FromUID();
            if (_uid == null)
                throw new AppException("Identificador Inválido!");
            ...
            // DB Model Update
            dbModel.UpdateFrom(mapper.Map<TipoPessoa>(model), new[] {
                "id"
            });
