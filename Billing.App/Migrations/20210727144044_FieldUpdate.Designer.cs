...
namespace Billing.App.Migrations
{
    ...
    [Migration("20210727144044_FieldUpdate")]
            ...
            modelBuilder.Entity("Billing.Service.Models.Categoria", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 581, DateTimeKind.Local).AddTicks(3719));
            ...
            modelBuilder.Entity("Billing.Service.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 583, DateTimeKind.Local).AddTicks(958));
            ...
            modelBuilder.Entity("Billing.Service.Models.ChatMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 586, DateTimeKind.Local).AddTicks(2060));
            ...
            modelBuilder.Entity("Billing.Service.Models.ChatMessageAttachment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 584, DateTimeKind.Local).AddTicks(5787));
            ...
            modelBuilder.Entity("Billing.Service.Models.Compra", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 592, DateTimeKind.Local).AddTicks(4957));
            ...
            modelBuilder.Entity("Billing.Service.Models.Comuna", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 594, DateTimeKind.Local).AddTicks(8554));
            ...
            modelBuilder.Entity("Billing.Service.Models.Contacto", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 596, DateTimeKind.Local).AddTicks(1570));
            ...
            modelBuilder.Entity("Billing.Service.Models.Endereco", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 597, DateTimeKind.Local).AddTicks(9312));
            ...
            modelBuilder.Entity("Billing.Service.Models.Entidade", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 543, DateTimeKind.Local).AddTicks(4663));
            ...
            modelBuilder.Entity("Billing.Service.Models.Estabelecimento", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 599, DateTimeKind.Local).AddTicks(8159));
            ...
            modelBuilder.Entity("Billing.Service.Models.Factura", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 603, DateTimeKind.Local).AddTicks(9757));
            ...
            modelBuilder.Entity("Billing.Service.Models.Funcionario", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 605, DateTimeKind.Local).AddTicks(3994));
            ...
            modelBuilder.Entity("Billing.Service.Models.Genero", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 555, DateTimeKind.Local).AddTicks(6736));
            ...
            modelBuilder.Entity("Billing.Service.Models.Municipio", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 560, DateTimeKind.Local).AddTicks(703));
            ...
            modelBuilder.Entity("Billing.Service.Models.Pessoa", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 562, DateTimeKind.Local).AddTicks(7992));
            ...
            modelBuilder.Entity("Billing.Service.Models.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 565, DateTimeKind.Local).AddTicks(8441));
            ...
            modelBuilder.Entity("Billing.Service.Models.ProdutoImagem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 568, DateTimeKind.Local).AddTicks(5916));
            ...
            modelBuilder.Entity("Billing.Service.Models.Provincia", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 569, DateTimeKind.Local).AddTicks(5206));
            ...
            modelBuilder.Entity("Billing.Service.Models.SubCategoria", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 570, DateTimeKind.Local).AddTicks(4188));
            ...
            modelBuilder.Entity("Billing.Service.Models.TipoEntidade", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 571, DateTimeKind.Local).AddTicks(3540));
            ...
            modelBuilder.Entity("Billing.Service.Models.TipoPessoa", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 572, DateTimeKind.Local).AddTicks(8527));
            ...
            modelBuilder.Entity("Billing.Service.Models.Titulo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 574, DateTimeKind.Local).AddTicks(2109));
            ...
            modelBuilder.Entity("Billing.Service.Models.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 610, DateTimeKind.Local).AddTicks(8435));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Codigo = "Usuario0001",
                            ConcurrencyStamp = "2372c4e6-5616-4f3a-88e3-412a84d15366",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOuy9J9f28x8pVWMSTovQog41UbHiWmnf5zdOOEfMgCwKo0h1swreBRzIXaRP50G8g==",
            ...
            modelBuilder.Entity("Billing.Service.Models.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 576, DateTimeKind.Local).AddTicks(1962));
            ...
            modelBuilder.Entity("Billing.Service.Models.VendaItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 40, 43, 579, DateTimeKind.Local).AddTicks(417));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<long>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            ConcurrencyStamp = "908067a3-0aed-4e52-b5eb-27247542b0e4",
                            Name = "Admin",
                        ...
                        {
                            Id = 2L,
                            ConcurrencyStamp = "5745be1f-7b03-4ac5-b9d4-f05f00aa2855",
                            Name = "Gestor",
                        ...
                        {
                            Id = 3L,
                            ConcurrencyStamp = "e21eac4f-8e5a-415b-a393-421267373957",
                            Name = "Funcionario",
                        ...
                        {
                            Id = 4L,
                            ConcurrencyStamp = "7ad960b1-7a86-401d-b315-d593e05fb475",
                            Name = "Vendedor",
                        ...
                        {
                            Id = 5L,
                            ConcurrencyStamp = "470390e9-3835-490b-b5ec-6c52d8964672",
                            Name = "Entidade",
