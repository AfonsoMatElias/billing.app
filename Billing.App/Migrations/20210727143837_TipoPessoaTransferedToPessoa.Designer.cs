...
namespace Billing.App.Migrations
{
    ...
    [Migration("20210727143837_TipoPessoaTransferedToPessoa")]
    partial class TipoPessoaTransferedToPessoa
    {
            ...
            modelBuilder.Entity("Billing.Service.Models.Categoria", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 610, DateTimeKind.Local).AddTicks(1534));
            ...
            modelBuilder.Entity("Billing.Service.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 611, DateTimeKind.Local).AddTicks(8231));
            ...
            modelBuilder.Entity("Billing.Service.Models.ChatMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 615, DateTimeKind.Local).AddTicks(2886));
            ...
            modelBuilder.Entity("Billing.Service.Models.ChatMessageAttachment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 613, DateTimeKind.Local).AddTicks(3432));
            ...
            modelBuilder.Entity("Billing.Service.Models.Compra", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 622, DateTimeKind.Local).AddTicks(2060));
            ...
            modelBuilder.Entity("Billing.Service.Models.Comuna", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 625, DateTimeKind.Local).AddTicks(8380));
            ...
            modelBuilder.Entity("Billing.Service.Models.Contacto", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 627, DateTimeKind.Local).AddTicks(3925));
            ...
            modelBuilder.Entity("Billing.Service.Models.Endereco", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 629, DateTimeKind.Local).AddTicks(1421));
            ...
            modelBuilder.Entity("Billing.Service.Models.Entidade", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 574, DateTimeKind.Local).AddTicks(372));
            ...
            modelBuilder.Entity("Billing.Service.Models.Estabelecimento", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 631, DateTimeKind.Local).AddTicks(2510));
            ...
            modelBuilder.Entity("Billing.Service.Models.Factura", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 635, DateTimeKind.Local).AddTicks(4798));
            ...
            modelBuilder.Entity("Billing.Service.Models.Funcionario", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 636, DateTimeKind.Local).AddTicks(9917));
            ...
            modelBuilder.Entity("Billing.Service.Models.Genero", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 585, DateTimeKind.Local).AddTicks(3658));
            ...
            modelBuilder.Entity("Billing.Service.Models.Municipio", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 589, DateTimeKind.Local).AddTicks(5122));
            ...
            modelBuilder.Entity("Billing.Service.Models.Pessoa", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 592, DateTimeKind.Local).AddTicks(7702));
            ...
            modelBuilder.Entity("Billing.Service.Models.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 595, DateTimeKind.Local).AddTicks(8019));
            ...
            modelBuilder.Entity("Billing.Service.Models.ProdutoImagem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 598, DateTimeKind.Local).AddTicks(5619));
            ...
            modelBuilder.Entity("Billing.Service.Models.Provincia", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 599, DateTimeKind.Local).AddTicks(4418));
            ...
            modelBuilder.Entity("Billing.Service.Models.SubCategoria", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 600, DateTimeKind.Local).AddTicks(3063));
            ...
            modelBuilder.Entity("Billing.Service.Models.TipoEntidade", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 601, DateTimeKind.Local).AddTicks(2689));
            ...
            modelBuilder.Entity("Billing.Service.Models.TipoPessoa", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 602, DateTimeKind.Local).AddTicks(6467));
            ...
            modelBuilder.Entity("Billing.Service.Models.Titulo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 604, DateTimeKind.Local).AddTicks(1977));
            ...
            modelBuilder.Entity("Billing.Service.Models.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 642, DateTimeKind.Local).AddTicks(4439));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Codigo = "Usuario0001",
                            ConcurrencyStamp = "ec31736e-d26a-45d0-a510-b9188bba8f30",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHMZK/jGKXC3NjD1mAJVGaahF/FPUqWRph56YKKG2IcYyAqapXTQWTSMEHLAcP1LDQ==",
            ...
            modelBuilder.Entity("Billing.Service.Models.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 606, DateTimeKind.Local).AddTicks(1));
            ...
            modelBuilder.Entity("Billing.Service.Models.VendaItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 15, 38, 36, 608, DateTimeKind.Local).AddTicks(2157));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<long>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            ConcurrencyStamp = "220e0255-c036-4900-bb88-81cf1fe43892",
                            Name = "Admin",
                        ...
                        {
                            Id = 2L,
                            ConcurrencyStamp = "1e483df0-3676-4ac7-9fc4-2076ce2dacef",
                            Name = "Gestor",
                        ...
                        {
                            Id = 3L,
                            ConcurrencyStamp = "a3584bfe-121b-4cd7-a7e9-b399b18e13c1",
                            Name = "Funcionario",
                        ...
                        {
                            Id = 4L,
                            ConcurrencyStamp = "59ad6364-afcd-4509-9c9d-c2fadeae4f8c",
                            Name = "Vendedor",
                        ...
                        {
                            Id = 5L,
                            ConcurrencyStamp = "f164688a-1be4-4b8a-8a35-d984ca3088be",
                            Name = "Entidade",
