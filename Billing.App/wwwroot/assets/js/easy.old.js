 ...
 */
 (function(global, factory){
    ...
    // methods to observe
    var observableMethods = [ 'push', 'pop', 'unshift', 'shift', 'splice' ];
    var getter, scopeGetter, $global = window, doc = $global.document;
    var Task = $global.Promise;
    ...
    function Easy($elSelector, options) {
        ...
        prototype.compile = Compiler.compile = function (config) {
            ...
            var srcElementName = (includerManager.isInc($$el) ? includerManager.src($$el) : null) || 
                $$el.inc || ($$el.__e__ || {}).src || './index.html';
            ...
            configEasyProperty($$el).__e__.src = srcElementName;
        ...
        function ReactiveArray(config) {
            ...
            forEach(observableMethods, function (method) {
