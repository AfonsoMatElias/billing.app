...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private IEnderecoService service = null;
        ...
        // GET: api/Endereco/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/Endereco
        [HttpPost]
        public async Task<Response> Post([FromBody] EnderecoDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/Endereco/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] EnderecoDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/Endereco/5:12837918237
        [HttpDelete("{uid}")]
