...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ITipoVendaService service = null;

        public TipoVendaController(ITipoVendaService service)
        {
        ...
        // GET: api/TipoVenda/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/TipoVenda
        [HttpPost]
        public async Task<Response> Post([FromBody] TipoVendaDto model)
        {
            if (model == null)
        ...
        // PUT: api/TipoVenda/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TipoVendaDto model)
        {
            if (model == null)
                throw new AppException("Objecto inválido!", true);
        ...
        // DELETE: api/TipoVenda/5:12837918237
        [HttpDelete("{uid}")]
