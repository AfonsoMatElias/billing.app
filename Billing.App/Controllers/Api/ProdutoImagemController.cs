...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private IProdutoImagemService service = null;

        public ProdutoImagemController(IProdutoImagemService service)
        {
            this.service = service;
        }

        // GET: api/ProdutoImagem
        [HttpGet]
        ...
        // GET: api/ProdutoImagem/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/ProdutoImagem
        [HttpPost]
        public async Task<Response> Post([FromBody] ProdutoImagemDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/ProdutoImagem/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] ProdutoImagemDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/ProdutoImagem/5:12837918237
        [HttpDelete("{uid}")]
