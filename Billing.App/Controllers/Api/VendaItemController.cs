...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private IVendaItemService service = null;

        public VendaItemController(IVendaItemService service)
        {
        ...
        // GET: api/VendaItem/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/VendaItem
        [HttpPost]
        public async Task<Response> Post([FromBody] VendaItemDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/VendaItem/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] VendaItemDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/VendaItem/5:12837918237
        [HttpDelete("{uid}")]
