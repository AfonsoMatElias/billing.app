...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ITipoFacturaService service = null;

        public TipoFacturaController(ITipoFacturaService service)
        {
        ...
        // GET: api/TipoFactura/5:12837918237
        [HttpGet("{uid}")]
        ...
        [HttpPost]
        public async Task<Response> Post([FromBody] TipoFacturaDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/TipoFactura/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TipoFacturaDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/TipoFactura/5:12837918237
        [HttpDelete("{uid}")]
