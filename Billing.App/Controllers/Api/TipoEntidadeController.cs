...
namespace Billing.App.Controllers.Api
{
    ...
    [ApiController]
    // [Authorize]
    public class TipoEntidadeController : ControllerBase
    {
        private ITipoEntidadeService service = null;

        public TipoEntidadeController(ITipoEntidadeService service)
        {
            this.service = service;
        }

        // GET: api/TipoEntidade
        [HttpGet]
        ...
        // GET: api/TipoEntidade/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/TipoEntidade
        [HttpPost]
        public async Task<Response> Post([FromBody] TipoEntidadeDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/TipoEntidade/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TipoEntidadeDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/TipoEntidade/5:12837918237
        [HttpDelete("{uid}")]
