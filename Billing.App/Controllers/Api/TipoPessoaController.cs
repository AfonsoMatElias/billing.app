...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ITipoPessoaService service = null;

        public TipoPessoaController(ITipoPessoaService service)
        {
        ...
        // GET: api/TipoPessoa/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/TipoPessoa
        [HttpPost]
        public async Task<Response> Post([FromBody] TipoPessoaDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/TipoPessoa/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TipoPessoaDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/TipoPessoa/5:12837918237
        [HttpDelete("{uid}")]
