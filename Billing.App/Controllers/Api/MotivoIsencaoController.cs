...
namespace Billing.App.Controllers.Api
{
    ...
    [ApiController]
    // [Authorize]
    public class MotivoIsencaoController : ControllerBase
    {
        private IMotivoIsencaoService service = null;

        public MotivoIsencaoController(IMotivoIsencaoService service)
        {
            this.service = service;
        }

        // GET: api/MotivoIsencao
        [HttpGet]
        ...
        // GET: api/MotivoIsencao/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/MotivoIsencao
        [HttpPost]
        public async Task<Response> Post([FromBody] MotivoIsencaoDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/MotivoIsencao/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] MotivoIsencaoDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/MotivoIsencao/5:12837918237
        [HttpDelete("{uid}")]
