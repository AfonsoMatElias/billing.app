...
namespace Billing.App.Controllers.Api
{
    ...
    [ApiController]
    // [Authorize]
    public class ProdutoMotivoIsencaoController : ControllerBase
    {
        private IProdutoMotivoIsencaoService service = null;

        public ProdutoMotivoIsencaoController(IProdutoMotivoIsencaoService service)
        {
            this.service = service;
        }

        // GET: api/ProdutoMotivoIsencao
        [HttpGet]
        ...
        // GET: api/ProdutoMotivoIsencao/5:12837918237
        [HttpGet("{uid}")]
        ...
        // POST: api/ProdutoMotivoIsencao
        [HttpPost]
        public async Task<Response> Post([FromBody] ProdutoMotivoIsencaoDto model)
        {
            if (model == null)
        ...
        // PUT: api/ProdutoMotivoIsencao/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] ProdutoMotivoIsencaoDto model)
        {
            if (model == null)
                throw new AppException("Objecto inválido!", true);
        ...
        // DELETE: api/ProdutoMotivoIsencao/5:12837918237
        [HttpDelete("{uid}")]
