...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ITipoProdutoService service = null;
        ...
        // GET: api/TipoProduto/5:12837918237
        [HttpGet("{uid}")]
        ...
        [HttpPost]
        public async Task<Response> Post([FromBody] TipoProdutoDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/TipoProduto/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TipoProdutoDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/TipoProduto/5:12837918237
        [HttpDelete("{uid}")]
