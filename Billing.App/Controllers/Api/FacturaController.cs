...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private IFacturaService service = null;
        ...
        // POST: api/Factura
        [HttpPost]
        public async Task<Response> Post([FromBody] FacturaDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/Factura/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] FacturaDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/Factura/5:12837918237
        [HttpDelete("{uid}")]
