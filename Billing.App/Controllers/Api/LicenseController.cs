...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ILicenseService service = null;
        ...
        // POST: api/License
        [HttpPost]
        public async Task<Response> Post([FromBody] LicenseDto model)
        {
            if (model == null)
        ...
        // PUT: api/License/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] LicenseDto model)
        {
            if (model == null)
                throw new AppException("Objecto inválido!", true);
        ...
        // DELETE: api/License/5:12837918237
        [HttpDelete("{uid}")]
