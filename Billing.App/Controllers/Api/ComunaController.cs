...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private IComunaService service = null;
        ...
        // POST: api/Comuna
        [HttpPost]
        public async Task<Response> Post([FromBody] ComunaDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/Comuna/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] ComunaDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/Comuna/5:12837918237
        [HttpDelete("{uid}")]
