...
namespace Billing.App.Controllers.Api
{
    ...
    public class GeneroController : ControllerBase
    {
        ...
        // POST: api/Genero
        [HttpPost]
        public async Task<Response> Post([FromBody] GeneroDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/Genero/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] GeneroDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/Genero/5:12837918237
        [HttpDelete("{uid}")]
