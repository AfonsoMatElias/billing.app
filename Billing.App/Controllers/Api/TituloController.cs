...
namespace Billing.App.Controllers.Api
{
    ...
    {
        private ITituloService service = null;
        ...
        // POST: api/Titulo
        [HttpPost]
        public async Task<Response> Post([FromBody] TituloDto model)
        {
            try
            {
                if (model == null)
        ...
        // PUT: api/Titulo/5:12837918237
        [HttpPut("{uid}")]
        public async Task<Response> Put(string uid, [FromBody] TituloDto model)
        {
            try
            {
                if (model == null)
        ...
        // DELETE: api/Titulo/5:12837918237
        [HttpDelete("{uid}")]
